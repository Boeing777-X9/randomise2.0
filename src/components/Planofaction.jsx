...
export default function Planofaction() {
  ...
  useEffect(() => {
    const generatedParticles = Array.from({ length: 30 }).map((_, i) => ({
      ...
      yMovement: [0, Math.random() * -100 - 50, 0],
  ...
  return (
    <section
      className="relative bg-gradient-to-br from-[#020108] via-[#0a051a] to-[#000000] py-14 sm:py-20 md:pb-44 overflow-hidden z-0"
      id="planofaction"
    ...
    >
      ...
      <div className="absolute top-0 left-1/4 z-0 transform-gpu blur-3xl" aria-hidden="true">
        <div
      ...
      <div className="absolute bottom-0 right-1/4 z-0 transform-gpu blur-3xl" aria-hidden="true">
        <div
